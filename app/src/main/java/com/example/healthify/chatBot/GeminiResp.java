...
import static com.example.healthify.chatBot.BuildConfig.apiKey;
...
public class GeminiResp {
    public static void getResponse(ChatFutures chatModel, String query, ResourceCallBack callBack){
